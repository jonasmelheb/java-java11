...
public class Stream_03_Test {
    ...
    public void test_mapping() throws Exception {
        ...
        Map<Gender, String> result = customers.stream().sorted((c1, c2) -> c1.getFirstname().compareTo(c2.getFirstname())).collect(Collectors.toMap(c -> c.getGender(), c -> c.getFirstname(), (s1, s2) -> s1 + "|" + s2));
